...
import io.isott.expertise.infra.common.rest.ErrorResponse;
...
public class RestExceptionHandler extends BaseController {
    ...
    public Response<ErrorResponse> handleExpertiseApiBusinessException(BusinessException ex, Locale locale) {
